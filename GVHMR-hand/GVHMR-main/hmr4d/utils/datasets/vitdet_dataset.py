...
class ViTDetDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        if keypoints_2d is None:
            self.keypoints_2d = np.zeros((len(boxes), 21, 3), dtype=np.float32)
        else:
            self.keypoints_2d = keypoints_2d.astype(np.float32)
    ...
    def __getitem__(self, idx: int) -> Dict[str, np.array]:
        ...
        item['hand_keypoints_2d'] = self.keypoints_2d[idx].copy()
        return item
