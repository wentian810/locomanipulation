...
#   GMR_HAND_MODEL=sharpa_g1 -> Unitree G1 body + external Sharpa Wave hands
...
case "$GMR_HAND_MODEL" in
    ...
    brainco)
        ...
        ;;
    *)
        echo "Unsupported GMR_HAND_MODEL=$GMR_HAND_MODEL (use sharpa|sharpa_g1|sharpa_h1_2|g1|brainco)" >&2
