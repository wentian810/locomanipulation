...
# ---- GMR core -----------------------------------------------------------
GMR_SOURCE="${GMR_SOURCE:-auto}"
GMR_AUTO_SOURCE_QUALITY_GATE="${GMR_AUTO_SOURCE_QUALITY_GATE:-1}"
GMR_AUTO_SOURCE_MAX_BAD_TRANS_RATIO="${GMR_AUTO_SOURCE_MAX_BAD_TRANS_RATIO:-0.03}"
GMR_AUTO_SOURCE_MAX_BAD_JOINT_RATIO="${GMR_AUTO_SOURCE_MAX_BAD_JOINT_RATIO:-0.10}"
GMR_AUTO_SOURCE_MAX_TRANS_DELTA_M="${GMR_AUTO_SOURCE_MAX_TRANS_DELTA_M:-0.25}"
GMR_AUTO_SOURCE_MAX_ROOT_TILT_P95_DEG="${GMR_AUTO_SOURCE_MAX_ROOT_TILT_P95_DEG:-20.0}"
GMR_AUTO_SOURCE_MAX_ROOT_TILT_DEG="${GMR_AUTO_SOURCE_MAX_ROOT_TILT_DEG:-40.0}"
GMR_AUTO_SOURCE_MAX_TRANS_FROM_PRE_M="${GMR_AUTO_SOURCE_MAX_TRANS_FROM_PRE_M:-0.40}"
...
GMR_HEIGHT_ADJUST_MODE="${GMR_HEIGHT_ADJUST_MODE:-global_foot_geom}"
GMR_GROUND_OFFSET="${GMR_GROUND_OFFSET:-0.0}"
GMR_SUPPORT_CONTACT_HEIGHT="${GMR_SUPPORT_CONTACT_HEIGHT:-0.08}"
GMR_SUPPORT_EXIT_CONTACT_HEIGHT="${GMR_SUPPORT_EXIT_CONTACT_HEIGHT:-0.10}"
GMR_SUPPORT_MAX_VERTICAL_SPEED="${GMR_SUPPORT_MAX_VERTICAL_SPEED:-1.20}"
GMR_SUPPORT_MAX_HORIZONTAL_SPEED="${GMR_SUPPORT_MAX_HORIZONTAL_SPEED:-0.15}"
...
GMR_HUMAN_YAW_OFFSET_DEG="${GMR_HUMAN_YAW_OFFSET_DEG:-0}"
...
GMR_PALM_ROLL_BODY_ALIGN="${GMR_PALM_ROLL_BODY_ALIGN:-auto}"
GMR_PALM_ROLL_BODY_ALIGN_DOT_MIN="${GMR_PALM_ROLL_BODY_ALIGN_DOT_MIN:-0.0}"
...
GMR_WRIST_PITCH_YAW_SOFT_MARGIN_RATIO="${GMR_WRIST_PITCH_YAW_SOFT_MARGIN_RATIO:-0.15}"
...
GMR_CAMERA_SUBJECT_ALIGN_XY="${GMR_CAMERA_SUBJECT_ALIGN_XY:-1}"
GMR_RENDER_SKIP="${GMR_RENDER_SKIP:-1}"
GMR_RENDER_MAX_FRAMES="${GMR_RENDER_MAX_FRAMES:-0}"
GMR_MUJOCO_GL="${GMR_MUJOCO_GL:-egl}"
GMR_RENDER_WIDTH="${GMR_RENDER_WIDTH:-960}"
GMR_RENDER_HEIGHT="${GMR_RENDER_HEIGHT:-720}"
GMR_RENDER_RADIUS="${GMR_RENDER_RADIUS:-2.2}"
GMR_SCENE_MUJOCO_NAME="${GMR_SCENE_MUJOCO_NAME:-}"
GMR_COMPOSITE="${GMR_COMPOSITE:-1}"
if [ -z "${GMR_COMPOSITE_NAME+x}" ]; then
    GMR_COMPOSITE_NAME="{clip}__2x2.mp4"
fi
GMR_COMPOSITE_HIDE_LABELS="${GMR_COMPOSITE_HIDE_LABELS:-1}"
...
GMR_SHARPA_RELIABILITY_SMOOTH_WINDOW="${GMR_SHARPA_RELIABILITY_SMOOTH_WINDOW:-9}"
GMR_SHARPA_LOW_CONF_RELIABILITY_THR="${GMR_SHARPA_LOW_CONF_RELIABILITY_THR:-0.25}"
...
if [ -z "${GMR_EMBODIMENT_LABEL+x}" ]; then
    if [ "$GMR_BRAINCO_HANDS" = "1" ]; then
        ...
        case "$GMR_ROBOT" in
            unitree_g1)
                GMR_EMBODIMENT_LABEL="Unitree G1 body + Sharpa Wave 22-DoF hands"
                ;;
            unitree_h1_with_hand|unitree_h1_with_hand_wrist)
...
if [ -z "${GMR_RENDER_NAME+x}" ]; then
    GMR_RENDER_NAME="{clip}__gmr.mp4"
fi
