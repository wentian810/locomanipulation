...
|---|---|---|---|
| Sharpa Wave on Unitree G1 | Integrated | local Sharpa asset from `do-as-i-do-main` + `GMR-master/assets/unitree_g1/g1_mocap_29dof.xml` | Select with `GMR_HAND_MODEL=sharpa_g1`. This keeps the stable G1 body and 3-DoF wrists, hides the stock rubber hand, and attaches the full Sharpa chain at the G1 palm flange. |
...
# G1 body + Sharpa Wave
GMR_HAND_MODEL=sharpa_g1 bash GVHMR-hand/GVHMR-main/tools/pipeline/run_batch_dataset6_hand4wholepp.sh
