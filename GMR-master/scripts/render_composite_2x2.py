#!/usr/bin/env python
"""2x2 composite: Original | GVHMR | ISSAC GYM | GMR Robot.
...
def build(args):
    ...
    print(f"[2x2] Reading ISSAC: {args.isaac}", flush=True)
    isaac_frames = read_all_frames(args.isaac)
    if not isaac_frames:
...
def parse_args():
    ...
    p.add_argument("--isaac", required=True, help="ISSAC GYM physics MP4")
    ...
    p.add_argument("--label_isaac", default="ISSAC GYM")
